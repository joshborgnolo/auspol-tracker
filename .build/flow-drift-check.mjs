...
// newtracker/gen-data.mjs (residuals, per-house baselines, pooled anomaly
// series — the per-house flow-share fits were deleted upstream in 4f7eafe
// and are gone here too) plus the
...
if (!mo || mo[1] === "null") { console.error("FAIL: flowDriftOn missing/null in the data asset — there are joined ALP-v-ON anomalies to report, so a null emission is a bug"); process.exit(1); }
