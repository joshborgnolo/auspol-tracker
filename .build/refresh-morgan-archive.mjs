...
.frame-wrap {
  ...
  max-width: var(--maxw); width: 100%; margin: 0 auto;
  padding: 18px calc(28px + env(safe-area-inset-right, 0px)) calc(28px + env(safe-area-inset-bottom, 0px)) calc(28px + env(safe-area-inset-left, 0px));
}
.credit {
...
/* ------- replicated tables ------- */
.rm-sec { margin-top: 26px; }
.rm-sec h2 {
  font-family: var(--serif); font-weight: 600; font-size: 17px;
  letter-spacing: 0.01em;
}
.rm-sub { font-size: 12.5px; color: var(--ink-3); margin: 2px 0 4px; }
.rm-sub a { color: inherit; text-decoration: underline; }
.rm-cap {
  font-size: 12.5px; font-weight: 600; color: var(--ink-3);
  margin: 14px 0 2px; font-variant-numeric: tabular-nums;
}
.rm-cap a { font-weight: 400; text-decoration: underline; color: var(--ink-3); }
...
${MASTHEAD}
  ...
  <div class="head-right">
    <div class="meta-item">
      ...
      <span class="meta-v"><a href="/">&larr; Back to live tracker</a></span>
    </div>
  </div>
</header>
