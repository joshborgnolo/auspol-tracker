...
export function validate(D) {
  ...
  D.polls.forEach((p, i) => {
    ...
    //      RedBridge/Accent wave's usrfiles.com report PDF) – an absolute
    ...
    if (p.methodUrl != null && !["YouGov", "Newspoll", "RedBridge / Accent", "RedBridge / Accent (MRP)"].includes(p.pollster))
